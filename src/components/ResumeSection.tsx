...
const ResumeSection = () => {
  ...
  return (
    <section
      id="resume"
      className="min-h-screen  text-white py-16 px-4 border-b-4 border-amber-950"
    >
      {isClient && (
        <motion.div
          ...
          className="max-w-6xl mx-auto bg-gray-700 backdrop-blur-lg border border-white/20 rounded-3xl p-10 shadow-[0_10px_50px_rgba(0,0,0,0.3)]"
        >
          {/* Header */}
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6">
              {(showAll ? experience : experience.slice(0, 3)).map(
                (exp, idx) => (
                  <motion.div
                    key={idx}
